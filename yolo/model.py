...
class NetBackbone(tf.keras.models.Model, ABC):
    ...
    def __init__(self, input_shape, alpha=0.1,use_bias=False):
        ...
        self.block3_residual5 = SeparateResidualBlock(128, alpha=alpha)
        self.block3_residual6 = SeparateResidualBlock(128, alpha=alpha)
        self.block3_residual7 = SeparateResidualBlock(128, alpha=alpha)
        self.block3_residual8 = SeparateResidualBlock(128, alpha=alpha)
        ...
        self.block4_residual5 = SeparateResidualBlock(256, alpha=alpha)
        self.block4_residual6 = SeparateResidualBlock(256, alpha=alpha)
        self.block4_residual7 = SeparateResidualBlock(256, alpha=alpha)
        self.block4_residual8 = SeparateResidualBlock(256, alpha=alpha)
        ...
        self.block5_residual3 = SeparateResidualBlock(512, alpha=alpha)
        self.block5_residual4 = SeparateResidualBlock(512, alpha=alpha)
...
class Net(tf.keras.models.Model, ABC):
    def __init__(self,input_shape,out_channels,alpha=0.1):
        ...
        # Backbone
        self.base_model = NetBackbone(input_shape)
...
if __name__ == "__main__":
    ...
    net = Net(input_shape=(416, 416, 3), out_channels=3 * (5 + 14))
    net.build()
    net.summary()
