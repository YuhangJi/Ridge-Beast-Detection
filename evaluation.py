...
if __name__ == '__main__':
    ...
    # from yolo.selfmobile_yolohead import YOLOV3  # mobilenetv1_yolo
    # from yolo.selfmobilev2_yolohead import YOLOV3  # mobilenetv2_yolo
    # from yolo.models import YOLOV3
    # from yolo.selfmodel_selfheadv1 import YOLOV3
    # from yolo.tiny_yolo3 import TinyYOLOV3
    # from yolo.c3_d53_yhead_se import YOLOV3
    # from yolo.c3_d53_mhead import YOLOV3
    # from yolo.dpcdarknet_yolohead_se import YOLOV3
    # from yolo.c_dpcdarknet_myolohead import YOLOV3
    from yolo.selfmodel_selfheadv4 import YOLOV3
    ...
    net = YOLOV3(input_shape=(IMAGE_HEIGHT, IMAGE_WIDTH, CHANNELS),
                 ...
                 backbone='darknet',alpha=0.1)
    # net = TinyYOLOV3(input_shape=(IMAGE_HEIGHT, IMAGE_WIDTH, CHANNELS), out_channels=3 * (CATEGORY_NUM + 5),
    #               alpha=0.1)
    net.build()
    net.summary()
