...
# argparse receiving list of classes to be ignored (e.g., python calculate_map.py --ignore person book)
parser.add_argument('-i', '--ignore', nargs='+', type=str, help="ignore a list of classes.")
# argparse receiving list of classes with specific IoU (e.g., python calculate_map.py --set-class-iou person 0.7)
